...
class ProductController extends BaseAdminController
{
    ...
    public function detail($id = '')
    {
        ...
        $data['series'] = \App\Series::withDescription()->arrange()->get();
        $data['collection'] = \App\Collection::withDescription()->arrange()->get();
        $data['business'] = \App\Business::withDescription()->arrange()->get();
    ...
    public function afterSave(Request $request, $customData = [], $model){
        ...
        $model->collection()->sync(request('collection'));
    }

    public function afterDelete(Request $request, $model){
        $model->business()->detach();
        $model->collection()->detach();
    }
